...
try:
    ...
    time.sleep(1)
    os.system('Then type: python2 vasaking.py')
...
\033[1;94mFACEBOOK  OWNER KING
                  
\033[1;92mFB PAGE   OWNER KING
...
"""
print("""
Owner: OWNER KING (R.K)
Facebook: Owner King

""")
CorrectUsername = "Owner"
...
\033[1;95mFb\033[1;97mOWNER KING"""
